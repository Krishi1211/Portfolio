...
export const Bio = {
  ...
  geeksforgeeks: "https://auth.geeksforgeeks.org/user/krishishwfbw",
  instagram: "https://www.instagram.com/krishi_shah_1211/",
  whatsapp:
    "https://wa.me/8369386540?text=Hi Krishi! I'd like to know more about your services.",
};
...
export const experiences = [
  {
    ...
    desc: "During my internship at Kenmark, I had the opportunity to gain hands-on experience in frontend development. I contributed to the development of web applications using Next JS, collaborated with the development team, and worked on various projects to enhance my skills in web development.",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  {
    img: Hack2Skill,
    role: "Co‑Lead Fullstack Development",
